...
const StepTwo = () => {
  const { changePlanType, pricing, data, setStep } = useGlobally();
  ...
  return (
    <section className="stepContainer">
      ...
      <div className="plans">
        <div
          className={`${data.planType === "Arcade" && "clicked"}`}
          data-plan="Arcade"
        ...
        >
          ...
          <span>
            ...
            <p className="price">
              $<span id="price">{data.planPricing === "mo" ? 9 : 9 * 10}</span>/
              {data.planPricing}
            </p>
          </span>
        </div>
        ...
        <div
          className={`${data.planType === "Advanced" && "clicked"}`}
          data-plan="Advanced"
          onClick={(e) => changePlanType(e)}
        >
          <i className="icon">
          ...
          <span>
            ...
            <p className="price">
              $
              <span id="price">{data.planPricing === "mo" ? 12 : 12 * 10}</span>
              /{data.planPricing}
            </p>
          </span>
        </div>
        ...
        <div
          className={`${data.planType === "Pro" && "clicked"}`}
          data-plan="Pro"
          onClick={(e) => changePlanType(e)}
        >
          <i className="icon">
          ...
          <span>
            ...
            <p className="price">
              $
              <span id="price">{data.planPricing === "mo" ? 15 : 15 * 10}</span>
              /{data.planPricing}
            </p>
          </span>
        </div>
      ...
      <div
        className={`toggleContainer ${
          data.planPricing !== "mo" && "toggleClicked"
        }`}
        onClick={(e) => pricing(e)}
      >
        <p>Monthly</p>
      ...
      <div className="btns">
        <Link className="link" to="/" onClick={() => setStep("/")}>
